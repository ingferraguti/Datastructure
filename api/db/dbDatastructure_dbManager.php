...
function getConnection() {
	...
	global $db_Datastructure_db_Url, $db_Datastructure_db_User, $db_Datastructure_db_Pass, $db_Datastructure_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Datastructure_db_Url.";dbname=".$db_Datastructure_db_DbName, $db_Datastructure_db_User, $db_Datastructure_db_Pass);
